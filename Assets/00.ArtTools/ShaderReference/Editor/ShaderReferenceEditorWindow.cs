...
namespace taecg.tools.shaderReference
{
    public class ShaderReferenceEditorWindow : EditorWindow
    {
        ...
        private string[] tabNames = new string[] { "GPU", "Pipline", "Properties", "Semantics", "Tags", "Render State", "Compile Directives", "Transformations", "Other", "BuildIn Variables", "Predefined Macros", "Platform Differences", "Math", "Lighting", "Miscellaneous", "Error Debug", "GLSL", "Setup"};
        ...
        #region 编缉器入口
        [MenuItem("美术工具/Shader参考大全... #R", false, -11)]
