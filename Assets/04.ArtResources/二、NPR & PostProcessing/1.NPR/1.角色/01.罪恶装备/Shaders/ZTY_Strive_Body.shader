Shader "ZTY/Strive/Body"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float _LightThreshold, _ShadowAOOffset, _LineIntensity, _RimWidth, _RimIntensity, 
                  _MetallicStepSpecularWidth, _MetallicStepSpecularIntensity, _CommonStepSpecularWidth, _CommonStepSpecularIntensity;
